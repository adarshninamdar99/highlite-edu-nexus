        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-500 hover:text-highlite-accent">
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-highlite-extralight/30 rounded-lg border border-highlite-extralight/50">
              <div className="flex items-center gap-2 mb-2">
                <Star className="h-4 w-4 text-highlite-accent" />
                <span className="font-medium text-highlite-primary">Join our newsletter</span>
              </div>
              <p className="text-sm text-gray-600 mb-3">Stay updated with the latest in education technology</p>
              <div className="flex gap-2">
                <input 
                  type="email" 
                  placeholder="Your email" 
                  className="flex-1 px-3 py-2 text-sm rounded border border-gray-300 focus:outline-none focus:border-highlite-accent"
                />
                <button className="bg-highlite-accent hover:bg-highlite-light text-white px-3 py-2 rounded text-sm">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="mt-6">
              <div className="bg-highlite-extralight/30 p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  <div className="w-8 h-8 rounded-full bg-highlite-accent/20 flex items-center justify-center mr-3">
                    <Star className="h-4 w-4 text-highlite-accent" />
                  </div>
                  <span className="font-medium text-highlite-primary">4.9/5 Rating</span>
                </div>
                <div className="flex">
                ...
                <p className="text-xs text-gray-600 mt-1">Based on 1,248 reviews</p>
              </div>
            </div>
          </div>
        </div>
